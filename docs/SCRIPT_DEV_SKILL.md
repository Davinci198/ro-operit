...
2. 用 `download_file` 下载 `https://cdn.jsdelivr.net/gh/Davinci198/fix-operit@main/tools/sandboxpackage_dev_install_or_update.js`
...
1. 每次正式开始新的 Sandbox Package 开发任务前，必须优先重新下载一次安装脚本，再重新运行本地脚本
   - 安装脚本下载地址：`https://cdn.jsdelivr.net/gh/Davinci198/fix-operit@main/tools/sandboxpackage_dev_install_or_update.js`
