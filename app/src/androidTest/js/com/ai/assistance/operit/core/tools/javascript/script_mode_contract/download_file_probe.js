...
const successCases = [
  {
    ...
    url: 'https://cdn.jsdelivr.net/gh/Davinci198/fix-operit@main/examples/types/android.d.ts',
  },
  {
    name: 'type_core.d.ts',
    url: 'https://cdn.jsdelivr.net/gh/Davinci198/fix-operit@main/examples/types/core.d.ts',
  },
  {
    name: 'type_results.d.ts',
    url: 'https://cdn.jsdelivr.net/gh/Davinci198/fix-operit@main/examples/types/results.d.ts',
  },
];

const failureCase = {
  name: 'missing_file.d.ts',
  url: 'https://cdn.jsdelivr.net/gh/Davinci198/fix-operit@main/examples/types/__definitely_missing_file__.d.ts',
};
