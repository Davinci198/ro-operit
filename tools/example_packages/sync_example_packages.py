...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Path to whitelist file (.txt or .json). If omitted, will use tools/example_packages/packages_whitelist.txt; "
    ...
    if not final_items:
        ...
        print("- Provide --include <name> or create tools/example_packages/packages_whitelist.txt.")
        return 0
